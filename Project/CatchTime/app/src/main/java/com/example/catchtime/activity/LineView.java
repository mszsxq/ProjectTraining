...
class LineView extends View {
     ...
     * 背景色
     */
    private int bgColor =0x0000000;
    /**
     * 刻度值字体大小
     */
    private int scaleTxtSize = 10;
    /**
     * 刻度字体颜色
     */
    private int scaleTxtColor = getResources().getColor(R.color.text_color_1);
    /**
     * 折线颜色
     */
    private int lineColor = getResources().getColor(R.color.text_color_1);
    /**
     * 折线粗细层度
     */
     ...
     * 外圈颜色
     */
    private int outCircleColor =getResources().getColor(R.color.text_color_1);
    /**
     * 内圈颜色
     */
    ...
    private void initPaint() {
        ...
        DOT_OUTER_CIR_RADIUS = dp2px(this.getContext(), 4.0F);
