...
public class TimeAdapterEnd extends BaseAdapter {
    ...
    public TimeAdapterEnd(Context context, List<Time> contents, int itemLayoutId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvName.setText(contents.get(position).getFinish_time());
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog.OnTimeSetListener listener1 = new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker timePicker, int hour, int min) {
                        if(hour<10 && min<10){
                            contents.get(position).setFinish_time("0"+hour+":"+"0"+min);
                        }else if (hour<10){
                            contents.get(position).setFinish_time("0"+hour+":"+min);
                        }else if (min<10){
                            contents.get(position).setFinish_time(hour+":"+"0"+min);
                        }else {
                            contents.get(position).setFinish_time(hour+":"+min);
                        }
                        zhi = contents.get(position).getFinish_time();
                        Log.e("stat",zhi);
